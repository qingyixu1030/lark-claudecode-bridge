...
grep FEISHU_APP_ID "/Users/cindy/projects/lark-claudecode-bridge/.env"
```
...
launchctl unload ~/Library/LaunchAgents/com.cindy.lark-claude.plist
...
# 看日志
tail -f "/Users/cindy/projects/lark-claudecode-bridge/stdout.log"
```
